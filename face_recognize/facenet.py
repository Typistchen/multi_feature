...
from face_recognize.nets.facenet import Facenet as facenet
from face_recognize.utils.utils import preprocess_input, resize_image, show_config
...
class Facenet(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"    : "D:/WorkRoom/postgraduate/Task/pytq5/face_recognize/model_data/facenet_mobilenet.pth",
        #--------------------------------------------------------------------------#
        #   输入图片的大小。
        #--------------------------------------------------------------------------#
